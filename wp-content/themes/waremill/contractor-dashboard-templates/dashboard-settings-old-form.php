<br/></br/><br/></br/><br/></br/>
								...
								<form action="" class="update_contractor_settings_form" name="update_contractor_settings_form"  method="POST" enctype="multipart/form-data" >
									<div class="row visible">
										...
										<div class="cell x4">
											<div class="input-block title-form-section">
												<h3><?php _e('Profile Settings', THEME_TEXT_DOMAIN); ?></h3>
												<div class="sep"></div>
											</div>
											...
											<div class="input-block title-form-section">
												<h3><?php _e('Logo', THEME_TEXT_DOMAIN); ?></h3>
												<div class="sep"></div>
											</div>
											...
											<div class="input-block title-form-section">
												<h3><?php _e('Portofolio', THEME_TEXT_DOMAIN); ?></h3>
												<div class="sep"></div>
											</div>
											<div class="input-block visible">
												<?php /*
												<h3><?php _e('Portofolio with previous products', THEME_TEXT_DOMAIN); ?></h3>
												<p class="smalltext"><?php _e('Accept file types: .png/.jpg/.jpeg/.gif; Max. size: 5MB / gallery', THEME_TEXT_DOMAIN); ?></p>
												<?php */ ?>
										...
										<div class="cell x8">
											<div class="cell x12 input-block title-form-section">
												<h3><?php _e('Main information', THEME_TEXT_DOMAIN); ?></h3>
												<div class="sep"></div>
											</div>
											...
											<?php /*?>
											<div class="cell x6">
												<div class="input-block" data-tip="Please write the password.">
											...
											<div class="cell x12 input-block title-form-section">
												<h3><?php _e('Company information (optional)', THEME_TEXT_DOMAIN); ?></h3>
												<div class="sep"></div>
											</div>
