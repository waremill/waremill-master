<?php /*Template Name: Contractor - Dashboard - All Messages*/
get_header(); ?>
									...
									<div class="text-content">
										...
										<div class="row">
											<div class="cell x4">
												...
												<h3 class="projectname"><b><?php _e('Customer: ', THEME_TEXT_DOMAIN); ?></b>
												<?php // other email address 
													if($customer['ID'] == $user_ID ){
														...
														echo ucwords($customer['user_firstname']).' '.ucwords($customer['user_lastname']); // $customer['user_email'];
													}
												?></h3>
											</div>
											...
											<div class="cell x2 datearea">
												...
												?>
												<span><?php echo $date->format('d/m/Y'); ?>
							...
							<div class="full-content">
								<div class="bids-listing ">
									<div class="no-bids noopacity">
										...
										<?php $customer_create_project = get_field('contractor_create_new_messages', 'options'); ?>
