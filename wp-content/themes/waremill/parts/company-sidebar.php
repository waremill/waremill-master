						...
						<div class="inner-content">
							<div class="input-block-wrapper">
								...
								<div class="input-block">
									<input type="text" name="contact_contractor_name" required="required" value="<?php if(isset($_SESSION['new_name']) && strlen($_SESSION['new_name']) > 0) { echo $_SESSION['new_name']; } ?>">
								</div>
								<label><?php _e('Your email (required)', THEME_TEXT_DOMAIN); ?></label>
								<div class="input-block">
									<input type="email" name="contact_contractor_email" required="required" value="<?php if(isset($_SESSION['new_email']) && strlen($_SESSION['new_email']) > 0) { echo $_SESSION['new_email']; } ?>">
								</div>
								<label><?php _e('Message (required)', THEME_TEXT_DOMAIN); ?></label>
								<div class="input-block">
									<textarea name="contact_contractor_message" required="required" minlength="50"><?php if(isset($_SESSION['new_message']) && strlen($_SESSION['new_message']) > 0 ) { echo $_SESSION['new_message']; } ?></textarea>
								</div>
							</div>
							<?php /*
							...
							<div class="floating-objects">
								...
								<input type="hidden" value="<?php echo wp_create_nonce('submit-contact-customer'); ?>" name="submit-contact-customer">
