<?php /*Template Name: Contractors Page*/
get_header(); ?>
<?php //var_dump($_POST) ; ?>
							...
							<?php /*
			 				...
			 				<?php  while ($loop->have_posts())	{  $loop->the_post(); ?>
				 				...
				 				<div class="product-line">
									...
									<div class="services-list">
										<ul> 
											<?php if(strlen($industry)){ ?><li><b><?php _e('Industry:', THEME_TEXT_DOMAIN); ?></b> <?php echo esc_html($industry); ?></li><?php } ?>
											<?php if(strlen($service)){ ?><li><b><?php _e('Services:', THEME_TEXT_DOMAIN); ?></b> <?php  echo esc_html($service); ?></li><?php } ?>
											<?php if(strlen($country)){ ?><li><b><?php _e('Country:', THEME_TEXT_DOMAIN); ?></b> <?php echo  $country; ?></li><?php } ?>
										</ul>
									</div>
									<?php } ?>
								</div>
...
<?php } else if(check_role_current_user('contractor' ) == true ){ ?>
